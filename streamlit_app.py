...
#             # --- ⭐️ UPDATED ZERO-SHOT BLOCK ⭐️ ---
#             elif model_choice in ["Zero-Shot (BART-Large)", "Zero-Shot (DistilBERT)", "Zero-Shot (DistilRoBERTa)"]:
#                 candidate_labels = label_encoder.classes_.tolist()
                
#                 model_map = {
#                     "Zero-Shot (BART-Large)": "facebook/bart-large-mnli",
#                     "Zero-Shot (DistilBERT)": "typeform/distilbert-base-uncased-mnli",
#                     "Zero-Shot (DistilRoBERTa)": "cross-encoder/nli-distilroberta-base"
#                 }
#                 zsl_pipeline = load_zsl_pipeline(model_map[model_choice])
        ...
        try:
            ...
            if model_choice in ["Naive Bayes", "SVM", "Random Forest"]:
                ...
                model_map = {
                    "Zero-Shot (BART-Large)": "facebook/bart-large-mnli",
                    "Zero-Shot (DistilBERT)": "typeform/distilbert-base-uncased-mnli",
                    "Zero-Shot (DistilRoBERTa)": "valhalla/distilroberta-mnli-12-3" # Corrected Model
                }
                zsl_pipeline = load_zsl_pipeline(model_map[model_choice])
